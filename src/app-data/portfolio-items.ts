...
export const PortfolioPages: PortfolioPageInfo[] = [{
    ...
    intro: '"Is It My Birthday?" is an silly mobile application designed to infuse each day with anticipation and joy. At its core, the app allows users to check whether it\'s their birthday, fostering a daily ritual filled with fun.',
